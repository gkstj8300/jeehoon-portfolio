	...
	strategy: {
		...
		cards: [
			...
			},
			{
				...
				why: '페이지 수가 많지 않아 언어별 라우팅을 늘리는 대신, 쿠키로 상태를 유지해 분기 비용을 낮췄습니다. 같은 주소를 공유해도 방문자가 고른 언어가 지켜집니다.',
			},
			{
				icon: 'shield',
				title: '무중단 배포 운영',
				text: '카페24 도메인 기반 환경에서 Root 파일 교체 방식으로 무중단 배포 운영. 개발용 도메인을 별도 구성해 안정성을 확보했습니다.',
				why: '공유 호스팅이라 배포 수단이 제한적이었습니다. Root 파일 교체와 개발용 도메인 분리로, 제한된 환경에서도 서비스 중단 없이 갱신하고 사전에 검증할 수 있게 했습니다.',
			},
		],
	},
	showcase: {
